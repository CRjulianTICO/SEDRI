...
if($dataToken["rol"]=="Profesor"){
    ...
    header("Location: http://ssedri.herokuapp.com/SEDRI/vistas/UIMantenimientoAlumno.php"); 
    exit();
}else{
    header("HTTP/1.1 301 Moved Permanently"); 
    header("Location: http://ssedri.herokuapp.com/SEDRI/vistas/UIListaAlumno.php"); 
    exit();
}
